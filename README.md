...
```bash
git clone https://github.com/Nur1Labs/CryptonoteEvo-Pool.git pool
cd pool
npm update
```
...
"poolServer": {
    ...
    "poolAddress": "Evoo64zh7dRFyB8dgDWZMLmzKBgGXYWZCG4NBF2VcvzEuiSQpMjyyiYJ1Ra696pZu56PPFQNBDdB1rZjyeX1RVKeWZgHg7pTxj"
    ...
    /* Set difficulty on miner client side by passing <address> param with .<difficulty> postfix
       minerd -u Evoo64zh7dRFyB8dgDWZMLmzKBgGXYWZCG4NBF2VcvzEuiSQpMjyyiYJ1Ra696pZu56PPFQNBDdB1rZjyeX1RVKeWZgHg7pTxj.5000 */
    "fixedDiff": {
        "enabled": true,
...
```bash
node init.js -config=config_cryptonoteevo.json
```
...
var irc = "irc.freenode.net/#cryptonote";

/* Contact email address. */
var email = "support@poolhost.com";

/* Market stat display params from https://www.cryptonator.com/widget */
var cryptonatorWidget = ["EVO-BTC", "EVO-USD", "EVO-EUR"];
