...
// The Evo address prefixes we use to detect malformed wallet addresses.
var EvoWalletBase58AddressPrefix = '2864026';
var EvoWalletBase58SubAddressPrefix = '536986';
...
function handleMinerMethod(method, params, ip, portData, sendReply, pushMessage){
    ...
    switch(method){
        case 'login':
            ...
            if (addressPrefix != EvoWalletBase58AddressPrefix && addressPrefix != EvoWalletBase58SubAddressPrefix) {
